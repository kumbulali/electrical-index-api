...
const indexRepo = dataSource.getRepository(Index).extend({
  async getNeighboringIndexes(
    ...
    return {
      previousIndex: previousRow || null,
      nextIndex: nextRow || null,
    };
  },
});
